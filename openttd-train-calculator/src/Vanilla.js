...
import { TrackGaugeVanilla } from './TrackGauge.js';
import { Generation } from './Generation.js';
import { allEnginesVanilla } from './Engines.js';
...
function getEngines() {
    ...
    let engines = allEnginesVanilla;
    engines = engines.filter(x => generations.includes(x.generation));
...
/**
 * 
 * @returns {TrackGaugeVanilla[]}
 */
function getTrackGauges() {
    const trackGauge = document.querySelector('#trackGauge').value;
    switch (trackGauge) {
        case 'All':
            return [TrackGaugeVanilla.normal, TrackGaugeVanilla.electric, TrackGaugeVanilla.monorail, TrackGaugeVanilla.maglev];
        case TrackGaugeVanilla.normal:
            return [TrackGaugeVanilla.normal];
        case TrackGaugeVanilla.electric:
            return [TrackGaugeVanilla.electric];
        case TrackGaugeVanilla.monorail:
            return [TrackGaugeVanilla.monorail];
        case TrackGaugeVanilla.maglev:
            return [TrackGaugeVanilla.maglev];
        default:
            return [];
    }
}
...
function getGenerations() {
    ...
    switch (generation) {
        case 'All': return [Generation.first, Generation.second, Generation.third, Generation.fourth, Generation.fifth, Generation.sixth];
